...
class SignUpEntrepreneurScreen extends StatefulWidget {
  const SignUpEntrepreneurScreen({super.key});

  @override
  State<SignUpEntrepreneurScreen> createState() =>
      _SignUpEntrepreneurScreenState();
}

class _SignUpEntrepreneurScreenState extends State<SignUpEntrepreneurScreen> {
